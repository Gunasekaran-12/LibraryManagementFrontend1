...
// import { BookOpen, Users, ClipboardList, UserCog, User, Sparkles, Home } from "lucide-react";
...
//     <Link
//       to={to}
//       className={`group relative flex items-center gap-3 px-6 py-3 rounded-2xl font-medium transition-all duration-500 overflow-hidden
//         ${active
//           ? "bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 text-white shadow-2xl transform scale-110 shadow-purple-500/30"
//           : "bg-white/80 backdrop-blur-sm text-gray-700 hover:bg-gradient-to-r hover:from-purple-50 hover:to-indigo-50 hover:text-purple-700 hover:shadow-xl hover:scale-105 border border-white/50"
//         }`}
//     >
//       {/* Animated Background Glow */}
//       <div className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${
...
//         {/* Animated Arrow */}
//         <span className={`ml-2 text-sm transition-all duration-300 transform ${
//           active 
//             ? 'opacity-100 translate-x-0 text-white' 
//             : 'opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 text-purple-500'
//         }`}>
//           ✦
//         </span>
//       </div>
